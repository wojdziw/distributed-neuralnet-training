...
\begin{document}
	...
	\subsection{Corrected custom setup}
	...
	Figure \ref{fig:plus_equals} shows yet another variation on the testing parameters in order to find the error in the network architecture setup. The sign of the parameter update in each of the layers was flipped, as shown in the line 5 in listing \ref{lst:modified_update}. \\
	
	\begin{lstlisting}[caption={Modified parameter update routine}\label{lst:modified_update},language=Python]
